...
int main(int argc, char * argv[]){
	if (argc!=7){ //para asegurarnos que el numero de parametros es correcto
	...
	ifstream f (argv[1]);
	f>>Pses;
	//cout<<Pses; //Muestra una lista con coordenadas, nombre y bandera de cada pais.
	...
	//preguntamos al usuario, que ruta quiere segun el codigo.
	...
	for (it=R.begin(); it != R.end(); ++it){ //problema en ++it
		Punto pto = (*it);
